...
// types
import {EditAdvertiseDetailType} from "@/types/components";
import {EditAdvertiseDetailFormType} from "@/types/constants";

// utils
import {categoryList, qualityList} from "@/utils/constants";
import {addAdvertiseDetailSchema} from "@/utils/validations";

const Detail = ({data, setData, onPrev, onNext}: EditAdvertiseDetailType) => {

    const formik:FormikProps<EditAdvertiseDetailFormType> = useFormik({
