...
const getNotificationIconByStatus = (status: "success" | "error" | "info") => {
    switch (status){
        case "success":
...
const getNotificationClassNameByStatus = (status: "success" | "error" | "info"): string => {
    switch (status){
        case "success":
...
export const notification = (message: string, status: "success" | "error" | "info") => {
